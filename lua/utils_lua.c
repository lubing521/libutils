 ...
 * =====================================================================================
 *
 *       Filename:  utils_lua.c
 *
 *    Description:  
 *
 *        Version:  1.0
 *        Created:  09/29/2012 03:42:01 PM
 *       Revision:  none
 *       Compiler:  gcc
 *
 *         Author:  马明 (maming), maming@qiyi.com
 *        Company:  奇艺世纪
 *
 * =====================================================================================
 */
...
#include <utils/server_conhash.h>
#include <utils/3des.h>
#include <utils/md5.h>
#include <uuid/uuid.h>
#include <lua.h>
#include <lualib.h>
...
/** 
 *        Name: 3des_encrypt
 * Description: 使用key加密data
 *   Parameter: data    ->  待加密数据
 *              key     ->  密钥
 *      Return: 
 *              加密后的值
 */
...
LUALIB_API int luaopen_utils_lua(lua_State *L)
{
    luaL_register(L,"utils_lua", utils_lua);
    return 0;
}
